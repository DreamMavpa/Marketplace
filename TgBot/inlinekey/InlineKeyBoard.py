...
def inline_menu_red_tooling_return(db_name, db_id):
    ...
    inline_menu_red_tooling = InlineKeyboardMarkup(row_width=1).add(inline_btn_tooling_name_towar,inline_btn_tooling_price,inline_btn_tooling_full_description)
...
def inline_menu_red_table_return(db_name, db_id):
    ...
    inline_menu_red_table = InlineKeyboardMarkup(row_width=1).add(inline_btn_table_name_towar,inline_btn_table_full_description,
                                                                ...
                                                                inline_btn_table_price_5,inline_btn_table_price_6,inline_btn_table_price_8,inline_btn_table_price_10,inline_btn_table_price_12)
...
def create_inline_btn(name_db,call_back):
    ...
    for i in range(len_items): 
        ...
        inline_catalog_menu_keyboard_array.add(InlineKeyboardButton(str(items_counter[0])+' '+str(items_counter[1]), callback_data=call_back+str(items_counter[0])+' '+str(name_db)))



#////////////////////////////////////////////////////////////////////////// цикл для создание страниц из кнопок в боте начало
    len_inline_catalog_menu_keyboard_array = len(inline_catalog_menu_keyboard_array.inline_keyboard)
    arrat_inline_keyboard = inline_catalog_menu_keyboard_array.inline_keyboard
    full_aray_number_of_pages = []
    number_of_pages = ceil(len_inline_catalog_menu_keyboard_array/5) 
